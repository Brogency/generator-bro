  ...
  creating: {
    ...
    urls: {
      ...
      replacement: function (self, content, src, dst, context) {
        ...
        var imports = [
          f('from {{cameltosnack viewset}} import {{modelName}}ViewSet', context)];
    ...
    viewset: {
      ...
      replacement: function (self, content, src, dst, context) {
        ...
        var imports = [
          ...
          f('from {{pyApp}}.models.{{cameltosnack modelName}} import {{modelName}}', context),
          f('from {{pyApp}}.serializers.{{cameltosnack modelName}} import {{modelName}}Serializer', context)];
